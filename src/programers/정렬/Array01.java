...
public class Array01 {
    public static void main(String[] args) {
        ...
        int[] solution = array01.solution01(array, commands);
        System.out.println(Arrays.toString(solution));

        List<Integer> integers = array01.solution02(array, commands);
    ...
    // List 리턴
    public List<Integer> solution02(int[] array, int[][] commands) {

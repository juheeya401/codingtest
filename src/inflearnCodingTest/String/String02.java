...
public class String02 {
    public static void main(String[] args) {
        ...
        //inflearnCodingTest.String result = personal(text);
        String result = solution(text);
        System.out.println(result);
    }

    public static String personal(String text) {
        StringBuilder answer = new StringBuilder(); // 인텔리J의 가르침! -> StringBuilder!! 처음에는 inflearnCodingTest.String 으로 선언 &  answer += Character.toLowerCase(one); 이렇게 썼다.
